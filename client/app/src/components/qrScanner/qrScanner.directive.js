(function() {
  ...
  angular.module('arkclient.components').directive('qrScanner', ['$rootScope', '$timeout', '$mdDialog', '$mdToast', $document, qrScanner]);

  function qrScanner($rootScope, $timeout, $mdDialog, $mdToast, $document) {
