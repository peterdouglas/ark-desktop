(function() {
  ...
  angular.module('arkclient.components').controller('QrScannerController', ['$scope', '$interval', '$timeout', '$window', '$document', ScannerController]);

  function ScannerController($scope, $interval, $timeout, $window, $document) {
